...
const Filters = ({ onFilterChange, cars }) => {
  ...
  // Mobile toggle for Filters panel
  ...
  const filterCars = () => {
    ...
    if (seats) {
      filtered = filtered.filter(
        (car) => car.number_of_seats === parseInt(seats)
      );
    }
  ...
  return (
    <>
      ...
      {isOpen && <div className="filters-backdrop" onClick={closeFilters} />}
      <div id="filters-panel" className={`filters ${isOpen ? "open" : ""}`}>
        ...
        <div className="filter-item">
          ...
          <div className="custom-dropdown">
            <button
              ...
              aria-expanded={isSeatsDropdownOpen}
            >
              {seats || "Select seats"}
            </button>
            {isSeatsDropdownOpen && (
